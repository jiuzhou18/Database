...
<body>
	<div class="ax_h1" style="position:absolute;
        ...
        <div style="position:absolute;
      	...
      	%>
      		<div class="ax_h2" style="position:absolute;  left:140px;  top:80px;
  					width:500px;  height:19px;  font-size:25px; color:#FF0000; text-align:left;">
      ...
      //Connect database.
		...
		String title[] ={"ProductID",  "ProductName", "Current store", "Add store value"}; 
		textx = 120;
		for(int i=0; i<title.length; i++){
	      	 ...
	      	 <form action="stockmodifyrun.jsp" method="post"> 
 			 <input  type="hidden" name="user" value="<%=userName%>"/>
	    ...
	    while(rs.next()){
			String para[] = new String[3];
  			para[0] = rs.getString("ProductID");
   			para[2] = rs.getString("ProductNumber");
   			String prosql = "select Name from Product where ProductID='" + para[0] + "'"; 
   			rs1 = stmt1.executeQuery(prosql);
   			rs1.next();
   			para[1] = rs1.getString("Name");
        ...
        <div style="position:absolute;  left:475px;  top:<%=texty%>px;
     	   ...
     	   font-family:'Arial Regular', 'Arial';  font-weight:400;  font-style:normal;
     	     font-size:13px;  text-decoration:none;  color:#000000; text-align:center;"
     	      type="submit" value="Submit Change" />
     	    </div>
        </form>
