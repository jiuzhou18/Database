...
<body>
	...
	boolean flag = false;
		...
		String sql="select * from StaffMember where StaffID = '" + userName + "' and password = '" + password + "'";
    ...
    if(flag){
    %>
       	<jsp:forward page="staffpage.jsp">
        <jsp:param name="user" value= "<%=userName %>" />
        </jsp:forward>
    <%
	}else{
		request.setAttribute("message", "Staff name or password is not paired!");
